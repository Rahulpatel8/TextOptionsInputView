...
- (void)doInit
{
    ...
    self.backgroundColor = [UIColor clearColor];
    self.knobView = [[ISColorKnobView alloc] initWithFrame:self.bounds];
    _continuous = false;
}
...
-(void)setColorDelegate:(id<ISColorWheelDelegate>)colorDelegate {
...
- (void)setBrightness:(CGFloat)brightness
{
    ...
    [self.colorDelegate colorWheelDidChangeColor:self];
}
